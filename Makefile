...
literals := ./build/literals/literal.o ./build/literals/int_literal.o ./build/literals/bool_literal.o  ./build/literals/char_literal.o ./build/literals/float_literal.o ./build/literals/string_literal.o
