...
IRCall::IRCall(std::shared_ptr<IRExpression> f, std::shared_ptr<IRExpressionList> a, std::shared_ptr<IRExpressionList> argLocations) : func(std::move(f)), args(std::move(a)), argumentLocations(argLocations)
{
